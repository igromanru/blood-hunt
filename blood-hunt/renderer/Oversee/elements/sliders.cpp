...
bool SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, float power)
{
    ...
    if (grab_bb.Max.x > grab_bb.Min.x)
        window->DrawList->AddRectFilled(frame_bb.Min + ImVec2(0, 5), grab_bb.Max - ImVec2(0, 5), ImColor(127, 126, 246), 6);
...
bool OverseeUI::Elements::SliderFloat(const char* label, float* v, float v_min, float v_max, const char* format, float power)
{
    return SliderScalar(label, ImGuiDataType_Float, v, &v_min, &v_max, format, power);
}

bool OverseeUI::Elements::SliderInt(const char* label, int* v, int v_min, int v_max, const char* format)
{
...
bool OverseeUI::Elements::SliderFloatStretched(const char* label, float* v, float v_min, float v_max, const char* format, float power)
{
    return SliderScalarStretched(label, ImGuiDataType_Float, v, &v_min, &v_max, format, power);
}

bool OverseeUI::Elements::SliderIntStretched(const char* label, int* v, int v_min, int v_max, const char* format)
{
