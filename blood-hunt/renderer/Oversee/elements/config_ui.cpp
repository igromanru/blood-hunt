...
bool OverseeUI::Elements::ConfigButton(const char* label, const char* data, const char* author)
{
    ...
    static std::map<ImGuiID, anim> circle_anim;
    ...
    if (it_circle->second.size > 65.f)
    {
        ...
        window->DrawList->AddText(bb.Min + ImVec2(130 + 20 - ImGui::CalcTextSize("\uf00d").x / 2, 60 + (120 - 75) / 2 - ImGui::CalcTextSize("\uf00d").y / 2), ImColor(203, 44, 55), "\uf00d");
