...
void OverseeUI::Elements::Checkbox(const char* label, const char* desc, bool* v)
{
    ...
    window->DrawList->AddCircleFilled(bb.Min + ImVec2(328 + 9 - 40 + Active, 25 + 3), 7, ImTricks::Animations::FastColorLerp(ImColor(211, 211, 211, 211), ImColor(127, 128, 246), Active / 18.f), 32);
