...
bool OverseeUI::Elements::Hotkey(const char* label, int* k)
{
    ...
    auto str = std::u8string(ICON_FA_LAYER_GROUP);
    ...
    if (g.ActiveId == id)
        ...
        window->DrawList->AddText(NULL, 13, bb.Min + ImVec2(18, 15), ImColor(211, 211, 211, 160 + int(Active * 91.f)), std::string{ str.begin(), str.end() }.c_str());

    return value_changed;
}

bool OverseeUI::Elements::HotkeyStretched(const char* label, int* k)
{
    using namespace ImGui;
    ...
    window->DrawList->AddText(NULL, 7, bb.Min + ImVec2(18 + 120, 13), ImColor(211, 211, 211, 160 + int(Active * 91.f)), std::string{ str.begin(), str.end() }.c_str());
