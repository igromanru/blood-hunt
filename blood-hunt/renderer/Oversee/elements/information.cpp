...
void OverseeUI::Elements::Information(const char* label, const char* desc, float p_data, const char* format)
{
    ...
    window->DrawList->AddText(NULL, 15, bb.Min + ImVec2(328 - ImGui::CalcTextSize(value_buf).x - 25, 57 / 2 - ImGui::CalcTextSize("\uf924").y / 2), ImColor(211, 211, 211, 211), "\uf924");
...
void OverseeUI::Elements::Information(const char* label, const char* desc)
{
    ImGuiWindow* window = ImGui::GetCurrentWindow();
    if (window->SkipItems)
        return;
...
void OverseeUI::Elements::Information(const char* label, const char* desc, int p_data, const char* format)
{
    ImGuiWindow* window = ImGui::GetCurrentWindow();
    if (window->SkipItems)
        return;
...
void OverseeUI::Elements::Information(const char* label, const char* desc, const char* p_data, const char* icon)
{
    ImGuiWindow* window = ImGui::GetCurrentWindow();
    if (window->SkipItems)
        return;
